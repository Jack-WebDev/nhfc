import { fetchAccidentPerVehicleTypeTotal, fetchAccidents, reportPerAccidentType, reportPerRoad } from "@/apiCalls";
import { PageHeader } from "@/components";
import { Report } from "@/modules/accidentReports";
import { accidentsPerTypeColumn } from "@/modules/accidentReports/columns";
...
const page = async (props: PageProps) => {
  ...
  const { accidents, error, total } = await reportPerAccidentType();
    ...
    <div className="flex flex-col gap-6 w-full">
      ...
      {dateFilteredAccidents && (
        <Report
          ...
          fromDate={fromDate}
          toDate={toDate}
          tableColumns={accidentsPerTypeColumn}
