import { fetchAccidentPerVehicleTypeTotal, fetchAccidents, reportPerRoad, reportPerRoadType } from "@/apiCalls";
import { PageHeader } from "@/components";
import { Report } from "@/modules/accidentReports";
import { accidentsPerRoadColumns } from "@/modules/accidentReports/columns/road";
import { accidentsPerRoadTypeColumns } from "@/modules/accidentReports/columns/roadType";
...
const page = async (props: PageProps) => {
  ...
  const { accidents, error, total } = await reportPerRoadType();
    ...
    <div className="flex flex-col gap-6 w-full">
      ...
      {dateFilteredAccidents && (
        <Report
          ...
          fromDate={fromDate}
          toDate={toDate}
          tableColumns={accidentsPerRoadTypeColumns}
