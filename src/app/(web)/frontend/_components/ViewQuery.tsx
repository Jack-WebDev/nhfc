...
const ViewQuery: React.FC<ViewQueryProps> = ({ isOpen, onClose, query, saveQuery }) => {
  ...
  return (
    ...
    {queries.map((query,index) => {
      console.log(query)
      return (
        <Modal isOpen={isOpen} onClose={onClose} key={index}>
        <div className="p-4">
          ...
          {/* <p><strong>Reference No:</strong> {queries.referenceNo}</p>
          <p><strong>Full Name:</strong> {queries.fullName}</p>
          <p><strong>Query Type:</strong> {queries.queryType}</p>
          <p><strong>Query Date:</strong> {queries.queryDate}</p>
          <p><strong>Query Status:</strong> {queries.queryStatus}</p>
          <p><strong>Description:</strong> {queries.description}</p>
          <p className="mb-4"><strong>Applied Loan:</strong> {queries.appliedLoan}</p> */}
          <div className="mb-4">
