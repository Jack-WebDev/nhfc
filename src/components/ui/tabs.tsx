...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-fit items-center justify-center  bg-transparent  text-muted-foreground",
      className
    )}
    {...props}
  />
